...
public class RotateCharacter : MonoBehaviour
{
    ...
    private static RotateCharacter _instance;
    public static RotateCharacter Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = FindObjectOfType(typeof(RotateCharacter)) as RotateCharacter;
    ...
    public void SetRotateCharacter(GameObject _pc)
    {
        pc = _pc;
